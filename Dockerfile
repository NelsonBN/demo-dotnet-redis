FROM mcr.microsoft.com/dotnet/sdk:8.0.100-preview.5-bookworm-slim AS build-env
...
FROM mcr.microsoft.com/dotnet/aspnet:8.0.0-preview.5-bookworm-slim AS final-env
